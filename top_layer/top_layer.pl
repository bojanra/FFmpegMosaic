...
if($clockLineLocation >= 0){
    ...
    my $kazalecSecondY;
    my $kazalecSecondX;
    my $kazalecSecendCircle = $clockCenterY-10;
    ...
    # Izračun kordinat kazalcev
        $kazalecSecondY = $clockCenterY  - int(sin(pi/2-($second*pi/30))*$kazalecDolzinaSecond);
        $kazalecSecondX = $clockCenterX  + int(cos(pi/2-($second*pi/30))*$kazalecDolzinaSecond);
        ...
        $kazalecHourY   = $clockCenterY  - int(sin(pi/2-($hour*pi/6))*$kazalecDolzinaHour);
        $kazalecHourX   = $clockCenterX  + int(cos(pi/2-($hour*pi/6))*$kazalecDolzinaHour);
